...
const UnifiedDatePicker: React.FC<UnifiedDatePickerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="relative z-10 w-full max-w-[400px] max-h-[calc(100dvh-2rem)] bg-white dark:bg-[#2d1b1b] rounded-xl shadow-2xl overflow-hidden flex flex-col items-stretch border border-white/20 animate-fade-in-down">
