...
describe('Dashboard Page', () => {
  ...
  describe('navigation', () => {
    ...
    it('should navigate to memory timeline from bottom nav', async () => {
      const user = userEvent.setup();
      renderDashboard();
      ...
      expect(mockNavigate).toHaveBeenCalledWith('/memory/timeline');
    });
  ...
  describe('quote section', () => {
    it('should display inspirational quote', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/"Home is wherever I am with you\."/)).toBeInTheDocument();
      });
    });
  });
